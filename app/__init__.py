...
from app.apiv1.views.orders import Orders, SpecificOrder, AcceptedOrders,DeclineOrder,DeclinedOrders,PendingOrders,CompleteOrder,CompletedOrders
...
def create_app(config_name='development'):
	...
	from .apiv1.views import orders_bp as orders_blueprint
